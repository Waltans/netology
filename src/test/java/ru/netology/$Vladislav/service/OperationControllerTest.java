package ru.netology.$Vladislav.service;

import org.junit.jupiter.api.Test;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.boot.test.context.SpringBootTest;
import ru.netology.$Vladislav.configuration.OperationProperties;
import ru.netology.$Vladislav.controller.OperationController;
import ru.netology.$Vladislav.controller.DTO.OperationDTO;
...
class OperationControllerTest {
    ...
    void getOperationsTest() throws InterruptedException {
        ...
        OperationDTO operation2 = new OperationDTO(3, 1, 200, "RUB", "Steam");
