...
import ru.netology.$Vladislav.OperationHistoryApiApplicationTest;
import ru.netology.$Vladislav.controller.CustomerController;
...
class CustomerControllerTest extends OperationHistoryApiApplicationTest {
    ...
    void addAndRemoveCustomer() {
        ...
        customerController.addCustomer(3, "Vlad");
        ...
        assertEquals("Vlad", newCustomer.getName());
